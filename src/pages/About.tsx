      ...
      <div className='max-w-6xl mx-auto px-4 py-12'>
        <div className='grid md:grid-cols-2 gap-12 items-center mb-20'>
          ...
          <div className='relative group'>
            <div className='absolute inset-0 bg-linear-to-r from-indigo-500 to-purple-500 rounded-2xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity'></div>
            <img 
        ...
        <div className='grid md:grid-cols-3 gap-6 mb-20'>
          ...
          <div className='group bg-white rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-indigo-500'>
            <div className='w-14 h-14 bg-linear-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform'>
